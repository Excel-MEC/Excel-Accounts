...
namespace API.Migrations
{
    ...
    [Migration("20200401065545_Adding category field to user model")]
    partial class Addingcategoryfieldtousermodel
    {
            ...
            modelBuilder.Entity("API.Models.School", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:IdentitySequenceOptions", "'2207', '1', '', '', 'False', '1'")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
